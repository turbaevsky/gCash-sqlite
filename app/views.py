...
### Charts ###
'''
class splitsChartView(GroupByChartView):
	datamodel = SQLAInterface(splits)
	chart_title = 'Data Example'
	#base_filters = [['post_date',FilterGreater,'2019-10-01']]
	#chart_type = "LineChart"
	definitions = [
	{
		'label': 'something',
		'group': 'transactions.description',
		'series': [(aggregate_count,'value')]
	}
]   
'''   
...
appbuilder.add_link(
	"showAll",
	href="/cash/api/v1/reportapi/info/showAll", ################ <<< add cash for api routing
	icon="fa-group",
	label="showAll",
	category="Info",
	category_icon="fa-cogs",
...
appbuilder.add_link(
	"show month report",
	href="/cash/api/v1/monthreportapi/info/monthly",
	icon="fa-group",
	label="show month report",
	category="Info",
	category_icon="fa-cogs",
)
